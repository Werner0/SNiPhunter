//Javascript for single rs number search
$(document).ready(function() {
  ...
  $("#singleButton").on("click", function() {
    ...
    $.ajax({
      ...
      for (var i=0; i < data.length; i++) {
        ...
        var textnode1 = document.createTextNode("SNP identifier "
          + rsID
          + " was mentioned at least "
          + cited + " time(s) in an article entitled ");
        var titlenode = document.createTextNode(title);
        var textnode2 = document.createTextNode(" published in "
          + year
          + ". The article has been tagged with Digital Object Identifier (DOI) "
          +  doi
          + " and Pubmed Central ID "
          + pub
        ...
        emailer.style.color = "black";
        emailer.style.textDecoration = "underline";
        ...
        func.style.textDecoration = "underline";
  ...
  //Clear old results on click event
