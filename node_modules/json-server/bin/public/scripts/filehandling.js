...
for(var i=0; i < fileString.length; i++) {
		...
		for(var i=0; i < data.length; i++) {
			...
			var textnode = document.createTextNode("SNP identifier " + rsID + " was mentioned at least " + cited + 
				" time(s) in an article entitled " + "\"" + title + "\"" + " published in " + year + ". The article has been tagged with the pubmed ID " + 
