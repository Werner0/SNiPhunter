$(document).ready(function() {
	...
	$("#singleButton").on("click", function() {
		...
		$.ajax({
	  	url: root + '/PMCOAI_rs_articles?keywords[]=' + input,
	 	method: 'GET',
		}).then(function(data) {
		var listz = [];
		for(var i=0; i < data.length; i++) {
			...
			var textnode1 = document.createTextNode("The term " + "\"" + input + "\"" + " is linked to an article entitled ");
			var titlenode = document.createTextNode(title);
			var textnode2 = document.createTextNode(" that also contains the SNP identifier " + rsID + ". This SNP identifier was mentioned at least " + cited +
				" time(s) in the article published in " + year + ". The article has also been tagged with Digital Object Identifier (DOI) " +  doi  +
				" and with Pubmed Central ID " +  pub +
			...
			emailer.href = "mailto:" + email + "?subject=Question about reference SNP " + rsID
			emailer.target = "_top"
			...
			func.href = "http://www.ncbi.nlm.nih.gov/snp/?term=" + rsID;
			func.target = "_blank"
