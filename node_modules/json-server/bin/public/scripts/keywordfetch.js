$(document).ready(function() {
	...
	$("#singleButton").on("click", function() {
		...
		for(var i=0; i < data.length; i++) {
			...
			var textnode = document.createTextNode("The term " + "\"" + input + "\"" + " is linked to an article that also contains the SNP identifier " + rsID + ". This SNP identifier was mentioned at least " + cited + 
